"""Generate an XML JBS problem file to be solved using Frodo 2. This program models the problem as a combined-variables formulation."""
...
comment = Comment('Please don\'t modify this file manually. Use the jbsXmlGen.py file to modify the problem instance instead.')
